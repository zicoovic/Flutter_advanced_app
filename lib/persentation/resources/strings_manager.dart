class AppStrings {
  ...
  static const String userNameInvalid =
      "Invalid username should be at least 6 chars";
  static const String mobileNumberInvalid =
      "mobile number should be at least 10 digits";
  static const String passwordInvalid = "Password should be minimum 8 chars";
  static const String alreadyHaveAccount = "Already have an account ? Login";
  static const String profilePicture = 'Profile Picture';
  static const pictureError = 'Please Enter your profile picture';
  static const photoGallary = 'Photo From Gallery';
  static const photocCamera = 'Photo From Camera';
